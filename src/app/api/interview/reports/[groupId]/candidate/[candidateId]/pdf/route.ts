...
/**
 * GET /api/interview/reports/[groupId]/candidate/[candidateId]/pdf
...
export async function GET(req: Request, { params }: Params) {
  ...
  const printUrl = `http://localhost:${port}/print/interview/candidate/${groupId}/${candidateId}?pdf_secret=${secret}`
  ...
  try {
    ...
    const rawName     = new URL(req.url).searchParams.get("name") ?? candidateId
