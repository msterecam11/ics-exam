...
export async function GET(
  ...
  const printUrl = `http://localhost:${port}/print/course/${courseId}?entity=${encodeURIComponent(entity)}&content=${encodeURIComponent(content)}&pdf_secret=${secret}${mode === "manual" ? "&mode=manual" : ""}`
