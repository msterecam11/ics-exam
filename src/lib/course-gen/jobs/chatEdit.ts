...
In a "custom" node a line accepts "arrow":"none|end|start|both", turning a rule into a connector — that is what makes a timeline, process chain or feedback loop possible rather than a set of unlinked boxes.
